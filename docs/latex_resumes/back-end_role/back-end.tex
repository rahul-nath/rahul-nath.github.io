...
\namesection{Rahul}{Nath}{ \urlstyle{same} \underline{\href{http://therahulnath.com}{\color{cyan} http://therahulnath.com}} |  \underline{\href{mailto:rahul.nath.eph@gmail.com}{\color{cyan}rahul.nath.eph@gmail.com}}\\ 516.491.9232 | Github: \underline{\href{https://github.com/rahul-nath}{\color{cyan}rahul-nath}}
}
...
\section{Education} 
\\[1\baselineskip]
\subsection{\underline{\href{https://www.timeshighereducation.com/world-university-rankings/2017/subject-ranking/computer-science\#!/page/0/length/25/sort_by/rank_label/sort_order/asc/cols/rank_only}{\color{cyan}Georgia Tech}}}
\descript{M.S. in Computer Science}
\location{Part-Time | \underline{\href{http://www.nytimes.com/2016/09/29/upshot/an-online-education-breakthrough-a-masters-degree-for-a-mere-7000.html}{\color{cyan}OMSCS}}}
...
\subsection{\underline{\href{http://www.forbes.com/top-colleges/list/}{\color{cyan}Williams College}}}
...
\location{\underline{\href{https://github.com/rahul-nath/PrePost2/blob/master/final_try.py}{\color{cyan}PrePost2}}}
\begin{tightemize}
...
\location{\underline{\href{https://github.com/rahul-nath/medicost}{\color{cyan}Medicost}} (MIT Hack Medicine Team, 24-hr hackathon)}
\begin{tightemize}
\item Created website to easily search cost requests and receipts made by doctors, standardizing expensive medical procedure costs for over 44 million Americans without medical insurance. This project used Flask, Grunt, JQuery, and Bootstrap.
\end{tightemize}
\sectionsep

\location{\underline{\href{https://github.com/rahul-nath/SchoolStuff/blob/master/classes/comp_sci/cs237/wave2/wave3.s}{\color{cyan}Virtual Assembly Language Emulation}}}
\begin{tightemize}
