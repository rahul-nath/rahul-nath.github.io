...
$(document).ready(function(){
    ...
    projects['Honors Senior Research: PrePost2'] = '<i>Learning Domain Models from Partially Observed Action Sequences</i>. I performed research on extending extant algorithms that learn action models from partially observed intermediate state information to learning models from sparse descriptions of action sequences. My goal was to find a way to facilitate closed knowledge loop automation by using the Internet to "fill in" missing information about the environment. Inputs to the algorithm include information about the domain and the aforementioned action sequences to discover static predicates for the actions. <br>See some of my <a href="https://github.com/rahul-nath/PrePost2/blob/master/final_try.py" target="_blank">source code</a>. It employs parallel processing, web scraping, and some machine learning.';
