...
$(document).ready(function(){
    ...
    projects['Queuer'] = 'I am an Android engineer with experience in integrating new technologies with applications. In June 2014 I gave a talk at the AnDevCon conference regarding Google Glass, iBeacons, and Android applications. I\'ve also developed an Android application called <strong>Queuer</strong> that allows people to keep track of different tasks they have to do and allows them to manage their completion. It utilizes Android tools such as Volley, GSON, and the SQLite database and was developed using the AGILE methodology. I worked in conjunction with a team and the code is available on my Github account. The app itself is not for sale, but it was fun making it.';
