...
$(document).ready(function(){
    ...
    var names = ['Medicost','Honors Senior Research','Virtual Assembly Emulation','Queuer']; // Laundry List App
    var pictures = ["images/medicost.jpg", "images/dfa.png", "images/assembly.png", "images/androiddev.jpg"];
    
    projects['Medicost'] = 'When I can, I like to attend Hackathons across the Northeast. Medicost is my project from the MIT Hacking Medicine Hackathon. It is designed to make it easy to look up the cost of a medical procedure by doctors accepting Medicare and Medicaid. For those without insurance, it is often difficult to anticipate the cost of expensive treatments until it is too late. This website allows such individuals to see the cost requests made by doctors to insurance companies and how much they received as a result of their requests, along with other information regarding the doctor\'s practice. Data was taken from the depths of the Dept. of Health and Human services website.';
    ...
    projects['Queuer'] = 'I am an Android engineer with experience in integrating new technologies with applications. In June 2014 I gave a talk at the AnDevCon conference regarding Google Glass, iBeacons, and Android applications. I\'ve also developed an Android application called <strong>Queuer</strong> that allows people to keep track of different tasks they have to do and allows them to manage their completion. It utilizes Android tools such as Volley, GSON, and the SQLite database and was developed using the AGILE methodology. I worked in conjunction with a team and the code is available on my Github account. The app itself is not for sale, but it was a great way to get my feet wet in app development.';
    ...
    ec['The Williams Octet'] = 'Coming into college I loved to sing, so I tried out and was accepted by <a href="http://williamsoctet.com" target="_blank">The Octet</a>, Williams\' oldest all-male a capella group, dating back to 1940. We sing for a variety of different charity events and fundraisers, including one that I started my freshman year called "Pay it Ephward", a silent auction dedicated to raising money for food kitchens in nearby North Adams.';
