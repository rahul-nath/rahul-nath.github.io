...
$(document).ready(function(){
    ...
    ec['WCFM'] = 'I currently serve as webmaster on the executive board of <a href="http://wcfm.williams.edu">WCFM</a>, Williams College\'s student-run radio station. I post on the blog, automate logistical services like subrequests and scheduling, and share my musical interests with the greater Williams community. In addition to being a radio DJ, I am also a campus DJ, playing gigs for school dances and private parties alike. Check out the link to my soundcloud below.';
