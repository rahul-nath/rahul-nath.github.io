...
$(document).ready(function(){
    ...
    projects['Medicost'] = 'In my recent college years, I would attend Hackathons across the Northeast. Medicost is my project from the MIT Hacking Medicine Hackathon, designed to make it easy to look up the cost of a medical procedure by doctors accepting Medicare and Medicaid. For those without insurance, it is often difficult to anticipate the cost of expensive treatments until it is too late. This website allows such individuals to see the cost requests made by doctors to insurance companies and how much they received as a result of their requests, along with other information regarding the doctor\'s practice. Data was scraped from the Dept. of Health and Human services.';
    projects['Honors Senior Research'] = '<i>Learning Domain Models from Partially Observed Action Sequences: PrePost2</i>. I performed research on extending extant algorithms that learn action models from partially observed intermediate state information to learning models from sparse descriptions of action sequences. My goal was to find a way to facilitate closed knowledge loop automation by using the Internet to "fill in" missing information about the environment. Inputs to the algorithm include information about the domain and the aforementioned action sequences to discover static predicates for the actions. <br>See the <a href="https://github.com/rahul-nath/PrePost2/blob/master/final_try.py" target="_blank">source code</a>. It employs parallel processing, web scraping, and supervised ML.';
